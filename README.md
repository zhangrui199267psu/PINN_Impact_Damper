...
## Uploaded dispersion files

Integrated the uploaded workflow as:
- `PINN/pinn_dispersion_from_mat.py` (script version),
- `PINN/pinn_dispersion_from_mat.ipynb` (notebook version).

Quick run example:

```bash
python PINN/pinn_dispersion_from_mat.py --mat Result/pinn_data.mat --out_dir Result/dispersion_plots --no_show
```

This command saves four figures:
1. `01_time_space_field.png`
2. `02_time_traces.png`
3. `03_fk_map.png`
4. `04_dispersion_ridge.png`
